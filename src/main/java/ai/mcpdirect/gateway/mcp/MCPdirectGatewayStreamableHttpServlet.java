...
//@WebServlet(
//        name = "MCPdirectGatewayStatelessHttpServlet",
//        urlPatterns = "/mcp/message",
//        asyncSupported = true
//)
public class MCPdirectGatewayStreamableHttpServlet extends HttpServlet
        implements McpStreamableServerTransportProvider {

    private static final Logger logger = LoggerFactory.getLogger(MCPdirectGatewayStreamableHttpServlet.class);
     ...
     * "/mcp".
     */
    private final String mcpEndpoint = "/mcp/message";

    /**
     * Flag indicating whether DELETE requests are disallowed on the endpoint.
     */
    private final boolean disallowDelete=true;
    ...
    public MCPdirectGatewayStreamableHttpServlet() {
...
//                .name("calculate").description("test mcpdirect tools")
//                .title("New test tool")
//                .inputSchema(EMPTY_JSON_SCHEMA)
//                .build();
        McpServerFeatures.AsyncToolSpecification tool = McpServerFeatures.AsyncToolSpecification.builder()
                .tool(McpSchema.Tool.builder()
                        .name("logging-test-v1")
                ...
                .callHandler((exchange, request) -> {
                                            return Mono.fromCallable(()-> {
                                                System.err.println(request);
                                                        return new McpSchema.CallToolResult("Test Success", false);
                                                    })
                ...
                .build();
//
//        mcpAsyncServer = McpServer.sync(this).serverInfo("test-server", "1.0.0")
...
//                                            .build()))
//                            .thenReturn(new McpSchema.CallToolResult("Logging test completed", false));
//                    //@formatter:on
//                })
//                .build();

        mcpAsyncServer = McpServer.async(this).serverInfo("test-server", "1.0.0")
                .capabilities(McpSchema.ServerCapabilities.builder().tools(true).build())
                .tools(tool)
                .build();

//        mcpAsyncServer.addTool(McpServerFeatures.SyncToolSpecification.builder()
//                .tool(newTool)
//                .callHandler((exchange, request) -> new McpSchema.CallToolResult(List.of(), false))
////                .callHandler((exchange, request) ->
////                        Mono.fromCallable(()-> {
////                            System.err.println(request);
////                                    return new McpSchema.CallToolResult(List.of(new McpSchema.TextContent("Test Success")), false);
////                                })
////                                .subscribeOn(Schedulers.boundedElastic()))
//                .build());
        ...
        public Mono<Void> sendMessage(McpSchema.JSONRPCMessage message, String messageId) {
            return Mono.fromRunnable(() -> {
                ...
                try {
                    ...
                    MCPdirectGatewayStreamableHttpServlet.this.sendEvent(writer, MESSAGE_EVENT_TYPE, jsonText,
                    ...
                    MCPdirectGatewayStreamableHttpServlet.this.sessions.remove(this.sessionId);
